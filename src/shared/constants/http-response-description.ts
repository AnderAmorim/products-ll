...
export const ERROR_ON_LIST_FAVORITE_PRODUCT = 'Error listing products';
export const ADD_FAVORITE_PRODUCT_SUCCESSFULLY = 'Product added to favorites successfully';
